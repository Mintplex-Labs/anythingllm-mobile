...
export const l10n = {
  en: {
    ...
    about: {
      ...
      supportProjectDescription:
        'If you enjoy using AnythingLLM, please consider supporting the project by:',
    ...
    feedback: {
      title: 'Send Feedback',
      description:
        'Your voice matters! Tell us how AnythingLLM is helping you and what we can do to make it even more useful.',
      shareThoughtsButton: 'Sharing your thoughts',
      useCase: {
        label: 'What are you using AnythingLLM for?',
      ...
      usageFrequency: {
        label: 'How often do you use AnythingLLM? (Optional)',
        options: {
          daily: 'Daily',
          weekly: 'Weekly',
          monthly: 'Monthly',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription:
          'Download a model to start chatting with AnythingLLM',
  ...
  ja: {
    ...
    about: {
      ...
      supportProjectDescription:
        'AnythingLLMをご利用いただき楽しんでいただけているなら、以下の方法でプロジェクトを応援いただけると幸いです：',
    ...
    feedback: {
      title: 'フィードバックを送信',
      description:
        'ご意見をお聞かせください！AnythingLLMの使い心地やより便利にするためのアイデアをお寄せください。',
      shareThoughtsButton: 'ご意見を共有する',
      useCase: {
        label: 'AnythingLLMをどのように使っていますか？',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription:
          'AnythingLLMとチャットを始めるにはモデルをダウンロードしてください',
  ...
  zh: {
    ...
    about: {
      ...
      supportProject: '支持项目',
      supportProjectDescription:
        '如果您喜欢使用AnythingLLM，请考虑通过以下方式支持项目：',
    ...
    feedback: {
      title: '发送反馈',
      description:
        '您的声音很重要！告诉我们AnythingLLM如何帮助您以及我们可以做什么来使其更有用。',
      shareThoughtsButton: '分享您的想法',
      useCase: {
        label: '您如何使用AnythingLLM？',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription: '要开始与AnythingLLM聊天，请下载模型',
        noModelsButton: '下载模型',
