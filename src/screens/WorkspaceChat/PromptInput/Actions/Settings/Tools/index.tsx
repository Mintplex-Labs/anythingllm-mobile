...
export default function ToolsAction() {
    ...
    useEffect(() => {
        ...
        uiStore.getFromStorage('tools', toolSettings)
            .then((storedToolSettings) => setToolSettings(prev => ({ ...prev, ...storedToolSettings })));
    }, [registerSheet]);

    return (
        <Fragment>
            <TouchableOpacity onPress={() => presentSheet(BOTTOM_SHEET_NAMES.TOOLS, true)} style={{ gap: 11 }} className='flex flex-col items-center justify-center'>
            ...
            <BottomSheetModal
                ...
                onDismiss={() => presentSheet(BOTTOM_SHEET_NAMES.SETTINGS, true)}
            >
