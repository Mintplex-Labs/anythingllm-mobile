...
/**
 * DeepSeek - hosted OpenAI-compatible API. Only the API key and model are configurable.
 */
class DeepSeekProvider extends BaseOpenAILikeProvider {
  ...
  constructor({ provider = 'deepseek', config = {} }: DeepSeekProviderConfig) {
