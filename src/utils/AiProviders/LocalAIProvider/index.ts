...
/**
 * LocalAI - self-hosted OpenAI-compatible server. The user supplies the base URL; the API key is optional.
 */
class LocalAIProvider extends BaseOpenAILikeProvider {
  ...
  constructor({ provider = 'localai', config = {} }: LocalAIProviderConfig) {
