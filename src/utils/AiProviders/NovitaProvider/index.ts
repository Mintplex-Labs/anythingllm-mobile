...
/**
 * Novita - hosted OpenAI-compatible API. Only the API key and model are configurable.
 */
class NovitaProvider extends BaseOpenAILikeProvider {
  public isExternalProvider: boolean = true;
  private baseURL: string = 'https://api.novita.ai/v3/openai';
  ...
  constructor({ provider = 'novita', config = {} }: NovitaProviderConfig) {
