...
const crossPlatformModels: Model[] = [
  ...
  // -------- Qwen 3.5 --------
  {
    ...
    type: 'Qwen',
    capabilities: ['text-generation', 'tool-use', 'multilingual'],
    size: 811843840,
    params: 800_000_000,
    isDownloaded: false,
  ...
  // -------- Qwen3-VL --------
  {
    ...
    description: '(Q4_K_XL) Qwen3-VL 2B is a vision-language model. Text chat works today; image input requires the separate mmproj file.',
    type: 'Qwen',
